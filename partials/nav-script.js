      ...
      if (li.querySelector(':scope > .sub-menu')){
        ...
        link.addEventListener('click', function(e){
          if (window.matchMedia('(max-width: 1099px)').matches){
            ...
            // Force a synchronous reflow. Works around a real-device repaint
            // bug (seen on mobile Safari) where children of a
            // position:sticky ancestor (our header) don't repaint
            // immediately after a class-driven display change, leaving the
            // submenu visually stuck open even though the class was removed.
